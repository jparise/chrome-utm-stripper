 ...
 */
const searchPattern = new RegExp('utm_|clid|_hs|icid|igshid|linkid|mc_|mkt_tok|yclid|_openstat|wicked|otc|oly_|rb_clickid|soc_', 'i');
...
const replacePattern = new RegExp(
    '([?&]' +
    '(icid|mkt_tok|(g|fb)clid|igshid|_hs(enc|mi)|linkid|mc_[ce]id|utm_(source|medium|term|campaign|content|cid|reader|referrer|name|social|social-type)|rb_clickid|yclid|_openstat|wickedid|otc|oly_(anon|enc)_id)|soc_(src|trk)' +
    '=[^&#]*)',
    'ig');
